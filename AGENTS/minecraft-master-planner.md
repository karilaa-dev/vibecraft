...
- **1,375 Minecraft 1.21.3 blocks** available in `context/minecraft_items.txt`
...
- **analyze_placement_area**: Scans blocks around a point to detect floor/ceiling/roof structure (used before furniture/roof placement)
- **terrain_analyzer**: Analyzes terrain elevation, composition, hazards, opportunities before building
...
- **minecraft_scale_reference.txt**: Player-scaled dimensions (room sizes, ceiling heights, spacing standards)
...
- **Stay within Minecraft 1.21.3 blocks** - Reference context/minecraft_items.txt
