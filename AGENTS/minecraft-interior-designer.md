...
**ALWAYS use spatial_awareness_scan (V2) BEFORE placing furniture:**
...
**Reference**: `context/minecraft_items.txt`
...
analyze_placement_area(center_x=102, center_y=65, center_z=102, analysis_type="furniture_placement")
Returns: {"recommended_floor_y": 65, "ceiling_y": 69}
