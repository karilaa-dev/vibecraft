...
- **`spatial_awareness_scan`** - ⚡ NEW V2! Scan before placement (MANDATORY for alignment)
...
- **Reference Minecraft 1.21.3 blocks** - Check context/minecraft_items.txt for valid names
